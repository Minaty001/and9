"""
app/integrations/realtime/engine.py — Realtime Engine.
...
class RealtimeEngine:
    ...
    def _is_cache_valid(self, cached_at: float) -> bool:
        ...
        return (time.time() - cached_at) < self.config.default_cache_ttl_seconds
    ...
    def fetch(self, request: InfoRequest) -> List[InfoResult]:
        ...
        for stype in source_types:
            ...
            try:
                ...
                if elapsed > self.config.freshness_timeout_ms:
                    logger.warning(
