...
import asyncio
import logging
from app.utils._flask_compat import Blueprint, request, jsonify, Response
...
def chat():
    ...
    try:
        from app.api.routes.routes import get_and9
...
def recall_cache_stats():
    ...
    from app.memory.episodic.memory import get_recall_cache_stats
...
def reminder_alerts():
    ...
    """
    from app.services.reminder.worker import get_alerts
    alerts = get_alerts()
...
def get_and9():
    ...
    if _and9_instance is None:
        from app.brain.planner import AND9
        from app.core.events import EventSystem
...
def and9_sync_apps():
    ...
    from app.services.automation.package_resolver import get_resolver
...
def get_personality():
    ...
    try:
        from app.utils._flask_compat import current_app
...
def pipeline_status():
    ...
    from app.core.pipeline_status import status_manager
    import json
    import queue
