...
register_skill("flashlight", "app.and9.actions.device_actions", "handle_flashlight", lambda p, e: {"query": f"flashlight {'on' if p.get('state') is True else 'off' if p.get('state') is False else ''}"})
register_skill("wifi", "app.and9.actions.device_actions", "handle_wifi", lambda p, e: {"query": f"wifi {'on' if p.get('state') is True else 'off' if p.get('state') is False else ''}"})
register_skill("bluetooth", "app.and9.actions.device_actions", "handle_bluetooth", lambda p, e: {"query": f"bluetooth {'on' if p.get('state') is True else 'off' if p.get('state') is False else ''}"})
register_skill("airplane_mode", "app.and9.actions.device_actions", "handle_airplane_mode", lambda p, e: {"query": f"airplane_mode {'on' if p.get('state') is True else 'off' if p.get('state') is False else ''}"})
...
register_skill("volume_up", "app.and9.actions.device_actions", "handle_volume", lambda p, e: {"query": "up"})
register_skill("volume_down", "app.and9.actions.device_actions", "handle_volume", lambda p, e: {"query": "down"})
register_skill("volume_mute", "app.and9.actions.device_actions", "handle_volume", lambda p, e: {"query": "mute"})
register_skill("volume_max", "app.and9.actions.device_actions", "handle_volume", lambda p, e: {"query": "max"})
