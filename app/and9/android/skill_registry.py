...
register_skill("list_reminders", "app.and9.actions.reminder_actions", "execute_list_reminders", lambda p, e: {})
register_skill("delete_reminder", "app.and9.actions.reminder_actions", "execute_delete_reminder", lambda p, e: {"reminder_id": p.get("reminder_id")})
register_skill("pause_reminder", "app.and9.actions.reminder_actions", "execute_pause_reminder", lambda p, e: {"reminder_id": p.get("reminder_id")})
register_skill("resume_reminder", "app.and9.actions.reminder_actions", "execute_resume_reminder", lambda p, e: {"reminder_id": p.get("reminder_id")})
register_skill("snooze_reminder", "app.and9.actions.reminder_actions", "execute_snooze_reminder", lambda p, e: {"reminder_id": p.get("reminder_id"), "minutes": int(p.get("minutes", 5)) if p.get("minutes") else 5})
register_skill("clear_all_reminders", "app.and9.actions.reminder_actions", "execute_clear_all_reminders", lambda p, e: {})
register_skill("show_completed_reminders", "app.and9.actions.reminder_actions", "execute_show_completed", lambda p, e: {})
