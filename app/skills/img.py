...
def chat():
    ...
    try:
        ...
        return jsonify({"reply": "I encountered an error", "status": "error"}), 500
...
def tts_voices():
    ...
    try:
        ...
        return jsonify({"error": "voice listing failed"}), 500
...
def dialogue_process():
    ...
    try:
        ...
        return jsonify({
            "response": "Dialogue error occurred",
            "intent": None,
            "status": "error",
...
def dialogue_state():
    ...
    try:
        ...
        return jsonify({"error": "state failed"}), 500
...
def dialogue_task_detail(task_id):
    ...
    try:
        ...
        return jsonify({"error": "task_detail_failed"}), 500
...
def depgraph_analyze():
    ...
    try:
        ...
        return jsonify({"error": "analyze_failed"}), 500
...
def depgraph_graph():
    ...
    try:
        ...
        return jsonify({"error": "graph_failed"}), 500
...
def depgraph_callers():
    ...
    try:
        ...
        return jsonify({"error": "callers_failed"}), 500
...
def depgraph_callees():
    ...
    try:
        ...
        return jsonify({"error": "callees_failed"}), 500
...
def depgraph_impact():
    ...
    try:
        ...
        return jsonify({"error": "impact_failed"}), 500
...
def depgraph_orphans():
    ...
    try:
        ...
        return jsonify({"error": "orphans_failed"}), 500
...
def depgraph_leaves():
    ...
    try:
        ...
        return jsonify({"error": "leaves_failed"}), 500
...
def depgraph_pagerank():
    ...
    try:
        ...
        return jsonify({"error": "pagerank_failed"}), 500
...
def depgraph_mermaid():
    ...
    try:
        ...
        return jsonify({"error": "mermaid_failed"}), 500
...
def depgraph_d3():
    ...
    try:
        ...
        return jsonify({"error": "d3_failed"}), 500
...
def depgraph_module():
    ...
    try:
        ...
        return jsonify({"error": "module_failed"}), 500
