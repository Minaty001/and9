...
from app.core.config import NEWS_API_KEY, NOTES_DIR, IS_TERMUX, IS_WINDOWS
...
def generate_image_task(prompt: str) -> dict:
    ...
    try:
        from app.skills.media.img import generate_image
...
def handle_device_command(query: str) -> dict:
    ...
    if _youtube_play_intent:
        from app.skills.media.youtube import handle_music_request
