...
from app.skills.android.action_registry import (
    get_action,
)
from app.skills.android.chrome_firewall import assert_not_chrome, ChromeFirewallError
...
def _call_handler(handler_path: str, action_type: str,
    ...
    Returns:
        Handler result dict.
    """
    from app.skills.android.skill_registry import execute_skill
