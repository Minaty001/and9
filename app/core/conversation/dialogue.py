"""
app/core/conversation/dialogue.py — Dialogue Tracker.
...
class DialogueTracker:
    ...
    Usage:
        ...
        state = tracker.update_state("session-1", "What's the weather?")
        topic = tracker.detect_topic("weather in mumbai")
    """
    ...
    def update_state(
        ...
        # Update recent entities and create references
