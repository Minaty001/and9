"""
app/core/conversation/reference.py — Reference Resolver.
...
class ReferenceResolver:
    ...
    Usage:
        ...
        resolved = resolver.resolve("it", "session-1", dialogue_states)
        refs = resolver.extract_references("What about it?")
    """
