...
class PersonalOS:
    ...
    def initialize(self):
        ...
        try:
            ...
            from app.core.procedural_memory import ProceduralMemory
            ...
            # 7. Automation System
            from app.core.automation_system import AutomationSystem
            ...
            from app.and9.brain.cognitive_engine import (
