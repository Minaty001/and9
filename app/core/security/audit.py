...
class SecurityEvent:
    ...
    def __init__(self, event_type: str, severity: str = "low", source: str = "",
                 details: Optional[Dict] = None, timestamp: Optional[datetime] = None,
                 user_id: str = "", ip_address: str = "", blocked: bool = False):
...
class AuditLogger:
    ...
    def export_logs(self, format: str = "json") -> str:
        ...
        if format == "json":
            return json.dumps(
                [{"event_type": e.event_type, "severity": e.severity, "source": e.source,
                  "user_id": e.user_id, "blocked": e.blocked,
