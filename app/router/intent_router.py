...
def _extract_time(query: str) -> dict:
    """DEPRECATED: Use app.utils.time_parser.parse_time() instead."""
...
def _extract_duration(query: str) -> Optional[int]:
    """DEPRECATED: Use app.utils.time_parser.parse_duration() instead."""
    from app.utils.time_parser import parse_duration
    return parse_duration(query)


def _extract_label(query: str) -> Optional[str]:
    """DEPRECATED: Use app.router.entity_extractor._extract_label() instead."""
    from app.router.entity_extractor import _extract_label
