...
from app.utils.time_parser import parse_time, parse_duration, parse_recurring
...
def extract_add_contact(query: str) -> dict:
    ...
    """
    from app.brain.planner.command_dictionary import ADD_CONTACT
    q = query.strip()
...
def extract_delete_contact(query: str) -> dict:
    ...
    Returns:
        {"contact_name": str | None}
    """
    from app.brain.planner.command_dictionary import DELETE_CONTACT
    q = query.strip()
...
def extract_search_contacts(query: str) -> dict:
    ...
    Returns:
        {"query": str | None}
    """
    from app.brain.planner.command_dictionary import SEARCH_CONTACTS
    q = query.strip()
