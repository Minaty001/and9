...
from app.brain.planner.brain_types import BrainResult, BrainType, IntentType
from app.brain.planner.normalizer import QueryNormalizer
from app.brain.planner.intent_router import detect_intent_with_confidence
from app.brain.planner.intent_validator import validate_intent
from app.skills.android.android_executor import execute as execute_action
from app.core.and9_logger import get_logger, is_debug_enabled
from app.core.intent_trace import TraceContext, log_trace
from app.brain.subconscious.subconscious_brain import SubconsciousBrain
from app.utils.timezone_utils import format_city_time_response
from app.core.pipeline_status import status_manager, PipelineStage
...
class Orchestrator:
    ...
    def __init__(self, events_sys=None, enable_patterns: bool = True):
        ...
        from app.brain.reflex.habit_brain import HabitBrain
    ...
    def process(self, query: str) -> Dict[str, Any]:
        ...
        with TraceContext(query) as trace:
            try:
                ...
                from app.skills.android.action_verifier import verify_action
                        ...
                        def run_bg_hooks():
                            try:
                                if self.learning_system:
                                    from app.brain.planner.cognitive_engine import CognitiveContext
    ...
    def _log_result(self, query: str, normalized: str,
        ...
        try:
            from app.core.activity_db import log_activity, format_action_result
