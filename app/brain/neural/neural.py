...
# Model paths resolution relative to this file
_models_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "ai", "models"))
...
NN_CONFIG = {
    ...
    "model_path": os.path.join(_models_dir, "intent_model.npz"),
    "vocab_path": os.path.join(_models_dir, "vocab.json"),
