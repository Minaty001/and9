...
**Learning:** In the Jarvis admin panel (), buttons lacked explicit `:focus-visible` states, falling back to default browser behavior which was difficult to see against the dark background.
