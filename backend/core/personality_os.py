...
class PersonalOS:
    ...
    def initialize(self):
        ...
        try:
            ...
            from backend.memory.long_term import ProceduralMemory
            ...
            try:
                from backend.memory.episodic.memory import get_memory
            ...
            # 5. Knowledge Graph
            try:
                from backend.memory.semantic.knowledge_graph import KnowledgeGraph
            ...
            # 7. Automation System
            from backend.services.automation.automation_system import AutomationSystem
            ...
            from backend.cognition.planner.cognitive_engine import (
