...
from backend.cognition.decision.reflection import ReflectionEngine
...
def recall_cache_stats():
    ...
    from backend.memory.episodic.memory import get_recall_cache_stats
...
def reminder_alerts():
    ...
    """
    from backend.services.reminder.worker import get_alerts
    alerts = get_alerts()
...
def create_timer():
    ...
    from backend.core.timer import get_timer_service
...
def and9_sync_apps():
    ...
    from backend.services.automation.package_resolver import get_resolver
...
def get_personality():
    ...
    try:
        from backend.utils._flask_compat import current_app
...
def pipeline_status():
    ...
    from backend.core.pipeline_status import status_manager
    import json
    import queue
