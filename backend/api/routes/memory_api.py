...
"""
import logging
from backend.utils._flask_compat import Blueprint, jsonify, request
from backend.api.routes.routes import get_personality
...
def get_working_memory():
    ...
    try:
        ...
        from backend.memory.working.working_memory import WorkingMemory
