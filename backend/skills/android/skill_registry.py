...
# Registering skills
register_skill("set_alarm", "backend.skills.android.alarm_actions", "execute_set_alarm", _alarm_mapper)
register_skill("set_timer", "backend.skills.android.timer_actions", "execute_set_timer", _timer_mapper)
register_skill("get_time", "backend.skills.android.time_actions", "handle_get_time", lambda p, e: {})
register_skill("set_reminder", "backend.skills.android.reminder_actions", "execute_set_reminder", _reminder_mapper)
register_skill("list_reminders", "backend.skills.android.reminder_actions", "execute_list_reminders", lambda p, e: {})
register_skill("delete_reminder", "backend.skills.android.reminder_actions", "execute_delete_reminder", lambda p, e: {"reminder_id": p.get("reminder_id")})
register_skill("pause_reminder", "backend.skills.android.reminder_actions", "execute_pause_reminder", lambda p, e: {"reminder_id": p.get("reminder_id")})
register_skill("resume_reminder", "backend.skills.android.reminder_actions", "execute_resume_reminder", lambda p, e: {"reminder_id": p.get("reminder_id")})
register_skill("snooze_reminder", "backend.skills.android.reminder_actions", "execute_snooze_reminder", lambda p, e: {"reminder_id": p.get("reminder_id"), "minutes": int(p.get("minutes", 5)) if p.get("minutes") else 5})
register_skill("clear_all_reminders", "backend.skills.android.reminder_actions", "execute_clear_all_reminders", lambda p, e: {})
register_skill("show_completed_reminders", "backend.skills.android.reminder_actions", "execute_show_completed", lambda p, e: {})
register_skill("call", "backend.skills.android.call_actions", "execute_call", _call_mapper)
register_skill("send_sms", "backend.skills.android.call_actions", "execute_message", _sms_mapper)
register_skill("open_app", "backend.skills.android.app_actions", "execute_open_app", _app_mapper)
register_skill("close_app", "backend.skills.android.app_actions", "execute_close_app", lambda p, e: {})
register_skill("youtube_search", "backend.skills.android.youtube_actions", "execute_youtube_search", _youtube_search_mapper)
register_skill("youtube_play", "backend.skills.android.youtube_actions", "execute_youtube_play", _youtube_search_mapper)
register_skill("flashlight", "backend.skills.android.device_actions", "handle_flashlight", lambda p, e: {"q": f"flashlight {'on' if p.get('state') is True else 'off' if p.get('state') is False else ''}"})
register_skill("flashlight_on", "backend.skills.android.device_actions", "handle_flashlight", lambda p, e: {"q": "flashlight on"})
register_skill("flashlight_off", "backend.skills.android.device_actions", "handle_flashlight", lambda p, e: {"q": "flashlight off"})
register_skill("wifi", "backend.skills.android.device_actions", "handle_wifi", lambda p, e: {"q": f"wifi {'on' if p.get('state') is True else 'off' if p.get('state') is False else ''}"})
register_skill("bluetooth", "backend.skills.android.device_actions", "handle_bluetooth", lambda p, e: {"q": f"bluetooth {'on' if p.get('state') is True else 'off' if p.get('state') is False else ''}"})
register_skill("airplane_mode", "backend.skills.android.device_actions", "handle_airplane_mode", lambda p, e: {"q": f"airplane_mode {'on' if p.get('state') is True else 'off' if p.get('state') is False else ''}"})
register_skill("open_camera", "backend.skills.android.device_actions", "handle_camera", lambda p, e: {})
register_skill("go_home", "backend.skills.android.device_actions", "handle_home", lambda p, e: {})
register_skill("volume_up", "backend.skills.android.device_actions", "handle_volume", lambda p, e: {"keyword": "up"})
register_skill("volume_down", "backend.skills.android.device_actions", "handle_volume", lambda p, e: {"keyword": "down"})
register_skill("volume_mute", "backend.skills.android.device_actions", "handle_volume", lambda p, e: {"keyword": "mute"})
