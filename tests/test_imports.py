...
def test_core_config():
    from app.core.config import GROQ_API_BASE, OPENCODE_API_BASE
...
def test_emotion_sad():
    from app.core.understanding import UnderstandingEngine
    ue = UnderstandingEngine()
    emotion, _ = ue.detect_emotion("feeling very sad today")
    assert emotion == "sad"
...
def test_emotion_angry():
    from app.core.understanding import UnderstandingEngine
    ue = UnderstandingEngine()
    emotion, _ = ue.detect_emotion("bahut gussa aa raha hai")
...
def test_emotion_neutral():
    from app.core.understanding import UnderstandingEngine
    ue = UnderstandingEngine()
    emotion, _ = ue.detect_emotion("tell me about the weather")
...
def test_orchestrator_routing():
    ...
    assert router.route("lock my pc") in ["pc", "device", "chat"]
    assert router.route("take a screenshot") in ["pc", "device", "chat"]
    assert router.route("switch to bluetooth audio") in ["audio", "device", "chat"]
