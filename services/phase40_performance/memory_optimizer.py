...
# Types that should not be recursed into for size estimation
...
class MemoryOptimizer:
    ...
    def profile_memory(self) -> Dict[str, Any]:
        ...
        Returns a dict with memory-related statistics.
        """
        usage = {}
        try:
            import psutil
            ...
            # Fallback to basic /proc/self/status
            try:
        ...
        usage["monitored_caches"] = {
            name: size for name, size in self._cache_sizes.items()
        }
        return usage
    ...
    def get_large_objects(self, threshold_mb: float = 10.0) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of dicts with type, size_mb, repr.
        """
        import gc
